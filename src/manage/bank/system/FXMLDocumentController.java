    ...
    public void loginAdmin(){
        ...
        try {
            ...
            if (userID.startsWith("DN")) {
                ...
                getData.name= "Ngân hàng LCB trụ sở Đà Nẵng";
                getData.id="TSDN";
            } else if (userID.startsWith("CT")) {
                connect = db.getConnection2();
                getData.name= "Ngân hàng LCB trụ sở Cần Thơ";
                getData.id = "TSCT";
            } else if (userID.startsWith("HCM")) {
                connect = db.getConnection3();
                getData.name= "Ngân hàng LCB trụ sở TP.Hồ Chí Minh";
                getData.id= "TSHCM";
            } else {
                connect = db.getConnection();
                getData.name= "Ngân hàng LCB trụ sở Tổng";
                getData.id="TSHN";
            }
