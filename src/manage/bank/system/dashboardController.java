...
public void CardDelete() {
    // Check if user has the required position to delete a card
    if (getData.id.equals("TSHN") || getData.chucvu.equals("Quản Trị Viên")) {
        Alert alert = new Alert(Alert.AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Chỉ có Giao Dịch Viên của trụ sở con mới có quyền xóa thẻ!");
        alert.showAndWait();
        return;
    }

    // SQL query to delete card from the Card table
    ...
    try {
        ...
        // Check if Card_ID field is empty
        if (Card_ID.getText().isEmpty()) {
            alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Vui lòng nhập ID Thẻ cần xóa!");
            alert.showAndWait();
        } else {
            // Check if the card exists in the database
            String check = "SELECT * FROM Card WHERE ID_Card = '" + Card_ID.getText() + "'";
            ...
            if (!result.next()) {
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Không tìm thấy ID Thẻ: " + Card_ID.getText());
                alert.showAndWait();
            } else {
                // Confirm deletion
                alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Confirmation Message");
                alert.setHeaderText(null);
                alert.setContentText("Bạn có chắc chắn muốn xóa Thẻ ID: " + Card_ID.getText() + "?");
                java.util.Optional<ButtonType> option = alert.showAndWait();
                ...
                if (option.isPresent() && option.get().equals(ButtonType.OK)) {
                    ...
                    alert.setTitle("Information Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Xóa Thẻ thành công!");
                    alert.showAndWait();

                    // Refresh list and reset fields
                    CardShowListData();
                    CardReset();
                }
            }
...
public void CardTypeDelete() {
    if (!getData.id.equals("TSHN")) {
        // Kiểm tra quyền hạn của người dùng
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Chỉ có Quản Trị Viên của trụ sở Tổng Hà Nội mới có quyền xóa Loại Thẻ!");
        alert.showAndWait();
        return;
    }

    // Kiểm tra thông tin ID loại thẻ
    if (CardType_ID.getText().isEmpty()) {
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Vui lòng nhập ID Loại Thẻ cần xóa!");
        alert.showAndWait();
        return;
    }

    String sql = "DELETE FROM CardType WHERE ID_CardType = ?";

    try {
        Connection connect = DatabaseConnectionManager.getConnection();
        Alert alert;

        // Kiểm tra xem ID Loại Thẻ có tồn tại trong cơ sở dữ liệu không
        String check = "SELECT ID_CardType FROM CardType WHERE ID_CardType = '" + CardType_ID.getText() + "'";
        statement = connect.createStatement();
        result = statement.executeQuery(check);
        ...
        if (!result.next()) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("ID Loại Thẻ: " + CardType_ID.getText() + " không tồn tại!");
            alert.showAndWait();
        } else {
            // Xác nhận xóa loại thẻ
            alert = new Alert(AlertType.CONFIRMATION);
            alert.setTitle("Confirmation Message");
            alert.setHeaderText(null);
            alert.setContentText("Bạn có chắc chắn muốn xóa Loại Thẻ ID: " + CardType_ID.getText() + "?");
            Optional<ButtonType> option = alert.showAndWait();
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                alert.setTitle("Information Message");
                alert.setHeaderText(null);
                alert.setContentText("Xóa Loại Thẻ thành công!");
                alert.showAndWait();

                // Cập nhật lại danh sách các loại thẻ
                CardTypeShowListData();
                CardTypeReset();
            }
        }
...
//        alert.setTitle("Error Message");
//        alert.setHeaderText(null);
//        alert.setContentText("Chỉ có Quản Trị Viên của trụ sở con mới có quyền xóa chi nhánh tương ứng với trụ sở đó!");
//        alert.showAndWait();
//        return;
//    }
//
...
public void DPDelete() {
    ...
    // Kiểm tra xem ID của chi nhánh có được nhập hay không
    if (DP_ID.getText().isEmpty()) {
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Vui lòng nhập ID Chi Nhánh để xóa!");
        alert.showAndWait();
        return;
    }

    String sql = "DELETE FROM Dp WHERE ID_dp = ?";
    try {
        Connection connect = DatabaseConnectionManager.getConnection();
        String check = "SELECT * FROM Dp WHERE ID_dp = '" + DP_ID.getText() + "'";
        Statement statement = connect.createStatement();
        ResultSet result = statement.executeQuery(check);
        ...
        if (!result.next()) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Không tìm thấy Chi Nhánh với ID: " + DP_ID.getText());
            alert.showAndWait();
        } else {
            Alert alert = new Alert(AlertType.CONFIRMATION);
            alert.setTitle("Confirmation Message");
            alert.setHeaderText(null);
            alert.setContentText("Bạn có chắc chắn muốn xóa Chi Nhánh ID: " + DP_ID.getText() + "?");
            Optional<ButtonType> option = alert.showAndWait();
            ...
            if (option.isPresent() && option.get().equals(ButtonType.OK)) {
                ...
                alert.setTitle("Information Message");
                alert.setHeaderText(null);
                alert.setContentText("Xóa Chi Nhánh thành công!");
                alert.showAndWait();
...
public void StaffDelete() {
    ...
    if (getData.id.equals("TSHN") || getData.chucvu.equals("Giao Dịch Viên")) {
        ...
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Chỉ có Quản Trị Viên của trụ sở con mới có quyền xóa nhân viên tương ứng với trụ sở đó!");
        alert.showAndWait();
        return;
    }
    
    // SQL statement for deleting a staff record
    ...
    try {
        ...
        if (Staff_ID.getText().isEmpty()) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Vui lòng nhập ID của nhân viên để xóa!");
            alert.showAndWait();
        } else {
            ...
            alert.setTitle("Confirmation Message");
            alert.setHeaderText(null);
            alert.setContentText("Bạn có muốn xoá Nhân viên: " + Staff_ID.getText() + "?");
            Optional<ButtonType> option = alert.showAndWait();
            ...
            if (option.isPresent() && option.get() == ButtonType.OK) {
                ...
                if (rowsAffected > 0) {
                    ...
                    alert.setTitle("Error Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Không tìm thấy nhân viên với ID: " + Staff_ID.getText());
                    alert.showAndWait();
                }
            }
        }
...
public void AccountDelete() {
    // Kiểm tra quyền trước khi thực hiện xóa tài khoản
    if (getData.id.equals("TSHN") || getData.chucvu.equals("Quản Trị Viên")) {
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Chỉ có Giao Dịch Viên của trụ sở con mới có quyền xóa tài khoản tương ứng với trụ sở đó!");
        alert.showAndWait();
        return;
    }

    // SQL query để xóa tài khoản khỏi bảng Account
    String sql = "DELETE FROM Account WHERE STK = ?";

    try {
        Connection connect = DatabaseConnectionManager.getConnection();
        Alert alert;

        // Kiểm tra xem số tài khoản có được nhập hay không
        if (Account_STK.getText().isEmpty()) {
            alert = new Alert(AlertType.ERROR);
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Vui lòng nhập Số Tài Khoản để xóa!");
            alert.showAndWait();
        } else {
            // Kiểm tra xem tài khoản có tồn tại trong cơ sở dữ liệu không
            String check = "SELECT * FROM Account WHERE STK = '" + Account_STK.getText() + "'";
            Statement statement = connect.createStatement();
            ResultSet result = statement.executeQuery(check);
            ...
            if (!result.next()) {
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Không tìm thấy Số Tài Khoản: " + Account_STK.getText());
                alert.showAndWait();
            } else {
                ...
                alert.setTitle("Confirmation Message");
                alert.setHeaderText(null);
                alert.setContentText("Bạn có chắc chắn muốn xóa tài khoản Số Tài Khoản: " + Account_STK.getText() + "?");
                java.util.Optional<ButtonType> option = alert.showAndWait();
                ...
                if (option.isPresent() && option.get().equals(ButtonType.OK)) {
                    ...
                    // Làm mới danh sách và đặt lại trường nhập liệu
                    AccountShowListData();
                    AccountReset();
                }
            }
...
public void CustomerDelete() {
    // Kiểm tra quyền trước khi thực hiện xóa khách hàng
    if (getData.id.equals("TSHN") || getData.chucvu.equals("Quản Trị Viên")) {
        Alert alert = new Alert(AlertType.ERROR);
        alert.setTitle("Error Message");
        alert.setHeaderText(null);
        alert.setContentText("Chỉ có Giao Dịch Viên của trụ sở con mới có quyền xóa Khách Hàng tương ứng với trụ sở đó!");
        alert.showAndWait();
        return;
    }

    // SQL query để xóa khách hàng khỏi bảng Customer
    ...
    try {
        ...
        if (Customer_ID.getText().isEmpty()) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Vui lòng nhập mã khách hàng cần xóa!");
            alert.showAndWait();
        } else {
            // Kiểm tra xem khách hàng có tồn tại trong cơ sở dữ liệu không
            String check = "SELECT * FROM Customer WHERE ID = '" + Customer_ID.getText() + "'";
            Statement statement = connect.createStatement();
            ResultSet result = statement.executeQuery(check);
            ...
            if (!result.next()) {
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Không tìm thấy Khách Hàng với mã: " + Customer_ID.getText());
                alert.showAndWait();
            } else {
                ...
                alert.setTitle("Confirmation Message");
                alert.setHeaderText(null);
                alert.setContentText("Bạn có chắc chắn muốn xóa Khách Hàng với mã: " + Customer_ID.getText() + "?");
                java.util.Optional<ButtonType> option = alert.showAndWait();
...
//    String sqlUpdateAccount2Linked = "SET XACT_ABORT ON;UPDATE [LINK_SERVER_TO_HN].[QLNHVN].[DBO].Account SET Sodu = ? WHERE STK = ?";
//
//    Connection connect = null;
//    PreparedStatement prepare = null;
...
//        if (!isLocalAccount) {
//            try {
//                String checkAccountLinked = "SELECT Sodu FROM [LINK_SERVER_TO_HN].[QLNHVN].[DBO].Account WHERE STK = ?";
